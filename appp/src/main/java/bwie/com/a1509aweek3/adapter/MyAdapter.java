package bwie.com.a1509aweek3.adapter;
...
import bwie.com.a1509aweek3.R;
import bwie.com.a1509aweek3.bean.OrderBean;
import bwie.com.a1509aweek3.presenter.CancleOrderPresenter;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        myViewHolder.tv.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                new AlertDialog.Builder ( context ).setTitle ( "提示" ).setMessage ( "确定取消订单吗？" ).setPositiveButton ( "是", new DialogInterface.OnClickListener () {
                    @Override
